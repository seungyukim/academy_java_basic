 ...
 * 창고에 있는 제품 1개의 정보를 출력하는 기능
 * 창고에 신제품을 새로 들여놓는 기능
 * 더 이상 판매하지 않는 제품을 폐기하는 기능
 * 창고에 들어있는 전체 제품 목록을 출력하는 기능
 * 
 * @author PC38209
 *
 */
public class ArrayWarehouse implements GeneralWarehouse {
	 ...
	 * 매개 변수가 있는 생성자
	 */
	ArrayWarehouse(Product[] products) {
