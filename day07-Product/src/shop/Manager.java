 ...
 *
 */
public class Manager implements ArrayWarehouse {
	...
	// (2) 매개변수가 있는 매니저 생성자
	Manager(ArrayWarehouse warehouse) {
		this.warehouse = warehouse;
	}
	
	// 3. 메소드 선언부

	public ArrayWarehouse getWarehouse() {
		return warehouse;
	}

	public void setWarehouse(ArrayWarehouse warehouse) {
		this.warehouse = warehouse;
	}
